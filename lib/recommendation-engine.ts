...
const JOB_DETAILS: Record<string, JobDetail> = {
  ...
  "작가": {
    description: "창작물을 작성하는 전문가",
    requiredSkills: ["작문 능력", "창의성", "연구 능력", "자기 표현"],
    personalityTraits: ["창의성", "통찰력", "감수성", "독립성"],
    salary: "변동성 높음",
    growth: "보통"
  },
  "간호사": {
    description: "환자를 돌보고 의료 서비스를 제공하는 전문가",
    requiredSkills: ["의학 지식", "환자 관리", "응급처치", "커뮤니케이션"],
    personalityTraits: ["공감능력", "헌신성", "책임감", "인내심"],
    salary: "4,000만원 ~ 8,000만원",
    growth: "높음"
  }
}
